...
<context-menu #oneContextMenu>
  ...
  <ng-template contextMenuItem (execute)="execute('Cut', $event)">Cut</ng-template>
  <ng-template contextMenuItem (execute)="execute('Copy', $event)">Copy</ng-template>
  <ng-template contextMenuItem (execute)="execute('Paste', $event)">Paste</ng-template>

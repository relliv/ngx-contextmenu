...
Its default styles are defined in the `@perfectmemory/ngx-contextmenu/src/assets/stylesheets/base.scss` file.
...
If you want more control over styling just copy the `@perfectmemory/ngx-contextmenu/src/assets/stylesheets/base.scss` and make your own adjustments
